...
import { PieChart, Wallet2, Bot, BarChart3 } from "lucide-react";
...
const features = [
  {
    ...
    icon: <PieChart className="w-8 h-8 text-indigo-600 dark:text-indigo-400" />,
  },
  {
    title: "Budget Planning",
    description:
      "Set monthly budgets for different categories and track your progress easily.",
    icon: <Wallet2 className="w-8 h-8 text-indigo-600 dark:text-indigo-400" />,
  },
  {
...
export default function Features() {
  return (
    <section id="features" className="dark:bg-gray-900 py-16 px-4">
      <div className="max-w-screen-xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-white">
          Features That Empower You
        </h2>
        <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Discover how our smart tools simplify money management and help you
